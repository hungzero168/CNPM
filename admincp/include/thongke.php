<table width="735" border="0" cellspacing="0" cellpadding="0">
  ...
  <?php
		$kq2=mysqli_query($conn, "select count(*) from giohang,sanpham,thanhvien where thanhvien.user=giohang.user AND giohang.id=sanpham.id and giohang.tinhtrang='damua'"); 
