...
?>		
        ...
        <tr height="30">
            ...
            <td align="center" width="140" style="border-right:1px solid #333; border-bottom:1px solid #333;"><dev class="myDIV"><strong><?php echo "$hoten"; ?></strong></dev>
          <dev class="hide">
...
<tr>
  <td colspan="6" align="left" style=" padding-right:10px;">Họ tên: <?php echo "$hoten"; ?> </td>
<tr>
