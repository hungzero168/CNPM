<?php
	$query=mysqli_query($conn,"select sanpham.*,giohang.* from giohang,sanpham where giohang.id=sanpham.id");
...
//******************************** Nội Dung ********************************//
      ...
      $tongtien3=0;
      $sql4="select sanpham.*,giohang.* from giohang,sanpham where giohang.id=sanpham.id and giohang.user='$user3' and giohang.ngaydat='$ngaydat'";
