...
<form method="post">
  ...
  <?php
        $kq2=mysqli_query($conn,"select count(*) from giohang,sanpham,thanhvien where thanhvien.user=giohang.user AND giohang.id=sanpham.id and giohang.tinhtrang='dathang'"); 
...
?>
     <tr height="30">
        ...
        <td align="center" width="140" style="border-right:1px solid #333; border-bottom:1px solid #333;"><dev style="color:#F00"><strong><?php echo "$hoten"; ?></strong></dev><br /><?php echo "$diachi"; ?><br /><?php echo "$email"; ?><br /><?php echo "$t"; ?></td>
