...
if(isset($_POST["act"]))
{
  ...
  if($hoten=="" || $diachi=="" || $email=="" || $dienthoai=="" || $user=="" || $pass=="")
  {
    echo "<script>alert('Bạn chưa nhập đầy đủ thông tin!');history.go(-1);</script>";
    exit;
  }
  if($pass!=$apass)
  {
    echo "<script>alert('Mật khẩu nhập lại không đúng!');history.go(-1);</script>";
    exit;
  }
		{    
...
<form method="post" onSubmit="return thanhvien_insert(user.value,pass.value,apass.value,hoten.value,email.value,diachi.value,dienthoai,anti.value);" id="formthanhvien" name="formthanhvien">
        <table width="560" cellspacing="0" cellpadding="0" bordercolordark="#FFFFFF" style="border:1px solid #CCC;">
          ...
          <tr bgcolor="#f9f9f9" onmouseover="style.background='#d4340c'" onmouseout="style.background='#F9F9F9'">  
            <td height="50" style="padding-left:70px"><div align="left" style="width:120px">Mật khẩu:</div></td>
              <td width="405" style="padding-left:15px" align="left">
                  <input type="password" name="pass" id="pass" style="width:220px" />   
                  <font color="#FF0000">* </font>
                </td>
          </tr>
          <tr bgcolor="#f9f9f9" onmouseover="style.background='#d4340c'" onmouseout="style.background='#F9F9F9'">  
            <td height="50" style="padding-left:70px"><div align="left" style="width:120px">Nhập lại mật khẩu:</div></td>
              <td width="405" style="padding-left:15px" align="left">
                  <input type="password" name="apass" id="apass" style="width:220px" />   
                  <font color="#FF0000">* </font>
                </td>
          </tr>
