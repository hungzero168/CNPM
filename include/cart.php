...
<form method="post" name="form">
  <tr>
    <td colspan="8" class="tieude" align="center">DANH SÁCH CÁC MẶT HÀNG ĐÃ ĐẶT</td>
  </tr>  
  <tr bgcolor="#ffcc99" align="center" height="30" style="font-weight:bold">
    ...
    <td width="150" style="border-right:1px solid #666">Thời gian đặt</td>
...
?>    
		<tr align="center" height="30" >
            ...
            <?php echo "$soluong"; ?>
            <td width="150" style="border-right:1px solid #666; border-bottom:1px solid #666">
            <?php echo "$ngaydat"; ?>
            </td>
...
<?php			
  ...
  ?>  
  <tr>
  	<td colspan="6" align="center" style="background-color:#d4340c; color:#FFF;" height="35">
 <?php
    //*******************************Xuất số trang************************************
	if($numrow==0)
